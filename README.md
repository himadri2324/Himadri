...
| [**SIEMSOC**](https://github.com/himadri2324/SIEMSOC) | Real-time SOC implementation using SIEM to detect, analyze, and respond to security incidents. | Elastic SIEM, Elasticsearch, Kibana, Winlogbeat, Windows Event Logs, Linux virtual machines, Azure Cloud, Azure Logic Apps |
